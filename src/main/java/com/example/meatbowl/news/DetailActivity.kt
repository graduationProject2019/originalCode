...
class DetailActivity : AppCompatActivity() {
    ...
    val ref= FirebaseDatabase.getInstance().getReference("test") //파이어베이스의 테스트 키를 가진 데이터의 참조 객체 가져옴

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(com.example.meatbowl.R.layout.activity_detail)
        /*
        ...
        val myList = findViewById(R.id.list) as RecyclerView
        ...
        FirebaseDatabase.getInstance().getReference("/Comments/$postId").addChildEventListener(object
            ...
            override fun onChildMoved(p0: DataSnapshot, prevChildKey: String?) {
                if (p0 != null) {
    ...
    inner class MyAdapter : RecyclerView.Adapter<MyViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
            ...
            return MyViewHolder(LayoutInflater.from(this@DetailActivity).inflate(com.example.meatbowl.R.layout.community_card_comment, parent, false))
        }
