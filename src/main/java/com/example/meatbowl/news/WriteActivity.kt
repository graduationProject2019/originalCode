...
import kotlinx.android.synthetic.main.community_card_post.view.*

class WriteActivity : AppCompatActivity() {
    // 현재 선택된 배경이미지의 포지션을 저장하는 변수
    var currentBgPosition = 0

    var mode= "post" //글쓰기 모드 저장하는 변수
    var postId= "" //댓글 쓰기인 경우 글 ID
    ...
    val bgList = mutableListOf(
        "android.resource://com.example.com.example.meatbowl.news/drawable/default_bg",
        "android.resource://com.example.com.example.meatbowl.news/drawable/dog1",
        "android.resource://com.example.com.example.meatbowl.news/drawable/dog2",
        "android.resource://com.example.com.example.meatbowl.news/drawable/dog3",
        "android.resource://com.example.com.example.meatbowl.news/drawable/dog4",
        "android.resource://com.example.com.example.meatbowl.news/drawable/dog5",
        "android.resource://com.example.com.example.meatbowl.news/drawable/dog6"
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //방금 생성한 레이아웃 매니저와 어뎁터를 recyclerView에 할당
        val myList = findViewById(android.R.id.list) as RecyclerView
        ...
        sendButton.setOnClickListener {
            ...
            if(mode== "post"){
                ...
                comment.message= input.text.toString() //메세지는 input EditText의 텍스트 내용을 할당
                comment.writerId= getMyId()
                comment.commentId= newRef.key!! //글의 ID는 파베 참조키로 활용
                comment.postId= postId //댓글 속한 글의 ID
                newRef.setValue(comment) //저장 성공
    ...
    inner class MyAdapter : RecyclerView.Adapter<MyViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
            ...
            return MyViewHolder(LayoutInflater.from(this@WriteActivity).inflate(R.layout.community_card_background, parent, false))
        }
